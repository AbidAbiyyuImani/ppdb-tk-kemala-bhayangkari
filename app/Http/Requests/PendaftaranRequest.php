...
class PendaftaranRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'akta-kelahiran' => ['required', 'file', 'mimes:pdf', 'max:2048'],
            'kartu-keluarga' => ['required', 'file', 'mimes:pdf', 'max:2048'],
            'ktp-orang-tua' => ['required', 'file', 'mimes:jpg,jpeg,png', 'max:2048'],
            'pas-foto-peserta-didik' => ['required', 'file', 'mimes:jpg,jpeg,png', 'max:2048'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'akta-kelahiran.required' => 'File akta kelahiran wajib diunggah.',
            'kartu-keluarga.required' => 'File kartu keluarga wajib diunggah.',
            'ktp-orang-tua.required' => 'File KTP orang tua wajib diunggah.',
            'pas-foto-peserta-didik.required' => 'File pas foto peserta didik wajib diunggah.',
        ];
    }
